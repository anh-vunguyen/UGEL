...
class Strategy:
    ...
    def _train(self, epoch, loader_tr, optimizer):
        ...
        self.training_info[f"epoch_{epoch}"] = {"loss": running_loss.item() / len(loader_tr), "acc": accFinal / len(loader_tr.dataset.X)}
    ...
    def train(self):
        ...
        elif self.args['net_type'] == 'pretrained_resnet18': # ResNet18
            self.clf = self.args['pretrained_resnet18']().cuda()
        else: 
